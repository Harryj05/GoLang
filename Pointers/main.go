...
// They provide a way to work with the memory directly, which can be useful for various programming tasks,
// including efficient memory management and sharing data between functions.
// To declare a pointer, you use the * (asterisk) symbol followed by the type of the variable it will point to.
// You can then initialize the pointer using the address-of (&) operator.
